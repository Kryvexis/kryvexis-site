    ...
    <div className="glass rounded-2xl p-5">
      ...
      <div className="mt-3 grid gap-3">
        ...
        <div className="flex items-center gap-2 text-xs">
          {{
            {{
              ok: (<><CheckCircle2 size={{14}} className="text-kx-cyan" /><span className="text-white/60">Saved to leads sheet</span></>),
              err: (<><AlertTriangle size={{14}} className="text-yellow-300" /><span className="text-white/60">Could not save lead (still opening)</span></>),
              null: (<span className="text-white/50">Email: {{EMAIL}} • WhatsApp: +27 68 628 2874</span>)
            }}[status]
          }}
        </div>
      </div>
